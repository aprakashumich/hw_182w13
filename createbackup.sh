...
ssh $uniquename@login.itd.umich.edu "mkdir eecs182HW;fs setacl eecs182HW $uniquename all -clear; fs setacl eecs182HW aprakash write; fs setacl eecs182HW vidal write; fs setacl eecs182HW njherman write; cd eecs182HW; git init --bare" 
